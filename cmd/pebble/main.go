...
func main() {
	...
	wfeImpl := wfe.New(logger, db, va, ca, *strictMode, c.Pebble.ExternalAccountBindingRequired, c.Pebble.SubdomainAuthAllowed, c.Pebble.RetryAfter.Authz, c.Pebble.RetryAfter.Order)
